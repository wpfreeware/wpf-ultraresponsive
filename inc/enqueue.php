...
function wpf_ultraresponsive_scripts() {
   ...
   // preloader
   	if( get_theme_mod( 'ultraResponsive_preloader_activation','enable' ) == 'enable' ){
   		wp_enqueue_script( 'wpf_ultraresponsive_preloaderjs', get_template_directory_uri() . '/js/queryloader2.js', array('jquery'), null, true );
   	}
   
   // wow animation
	if( get_theme_mod( 'ultraResponsive_animation_activation', 'enable') == 'enable' ) { 
		wp_enqueue_script( 'wpf_ultraresponsive_wowjs', get_template_directory_uri() . '/js/wow.js', array('jquery'), null, true );
		wp_enqueue_script( 'wpf_ultraresponsive_wow_activation', get_template_directory_uri() . '/js/wow_activation.js', array('wpf_ultraresponsive_wowjs'), null, true );
	}
	
	wp_enqueue_script( 'wpf_ultraresponsive_bootstrapjs', get_template_directory_uri() . '/js/bootstrap.js', array('jquery'), null, true );
    ...
    if( get_theme_mod( 'ultraResponsive_animation_activation','enable') == 'enable' ): 
    	wp_enqueue_style( 'wpf_ultraresponsive_animation', get_template_directory_uri() . '/css/animate.css','all' );
    endif;
